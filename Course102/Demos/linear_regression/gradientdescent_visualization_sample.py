...
ax.set_xlabel('b', labelpad=30, fontsize=24, fontweight='bold')
ax.set_ylabel('a', labelpad=30, fontsize=24, fontweight='bold')
...
fig.suptitle("Minimizando Loss(a,b)", fontsize=24, fontweight='bold')
plt.show()
